			...
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
						$i = 1;
						$movie = $conn->query("SELECT id,image,movie_name,release_date FROM movie_details GROUP BY movie_name   ");
						while($row=$movie->fetch_assoc()){
						 ?>
						 <tr>
						 	<td><?php echo $i++ ?></td>
						 	<td><center><img src="../image/<?php echo $row['image'] ?>" alt=""></center></td>
						 	<td><?php echo ucwords($row['movie_name']) ?></td>
