...
<div class="card ">
                <div class="card-header">
                    ...
                    <h6> Inox theater,SGPDA Market Comple,2nd Floor,Osia
							   Commercial Arcade,Margao,Goa-403601</h6></center>
                    <?php 
                  include "Database.php";
                  $result = mysqli_query($conn,"SELECT c.movie,c.booking_date,c.show_time,c.seat,c.totalseat,c.price,c.payment_date,c.custemer_id,u.username,u.email,u.mobile,u.city,t.theater FROM customer_record c INNER JOIN customer u on c.uid=u.id INNER JOIN theater_show t on c.show_time=t.show WHERE custemer_id = '".$_SESSION['custemer_id']."'");
