                    ...
                    <div class="tab-content">
                        <div class="row">
                                ...
                                if(isset($_POST['submit'])){
                                    $show = $_POST['show'];
                                $result = mysqli_query($conn,"SELECT u.username,u.email,u.mobile,u.city,t.theater FROM customer u INNER JOIN theater_show t on u.username = '".$username."' WHERE t.show = '".$show."'");
